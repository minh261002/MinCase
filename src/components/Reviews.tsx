...
function Review({ imgSrc, className, ...props }: ReviewProps) {
    ...
    const POSIBLE_ANIMATION_DELAYS = ['0s', '0.1s', '0.2s', '0.3s', '0.4s', '0.5s']
    const animationDelay = POSIBLE_ANIMATION_DELAYS[Math.floor(Math.random() * POSIBLE_ANIMATION_DELAYS.length)]
...
function ReviewGrid() {
    ...
    return (
        <div ref={containerRef} className="relative -mx-4 mt-16 grid h-[49r]
