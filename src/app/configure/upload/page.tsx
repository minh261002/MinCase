                ...
                >
                    {({ getRootProps, getInputProps }) => (
                        <div className="w-full h-full flex-1 flex flex-col items-center 
                            ...
                            <input {...getInputProps()} />
                            {
                                isDragOver ? <MousePointerSquareDashed className="w-6 h-6 text-zinc-500 mb-2" />
                                    : isUploading || isPending ? <Loader2 className="animate-spin w-6 h-6 text-zinc-500 mb-2" />
                            ...
                            {
                                isPending ? null : <p className="text-xs text-zinc-500">PNG, JPG, JPEG, WEBP</p>
                            }
                        </div>
                    )}
                </Dropzone>
