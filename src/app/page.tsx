        ...
        <MaxWidthWrapper className="pb-24 pt-10 lg:grid lg:grid-cols-3 sm:pb-32 lg:gap-x-0 xl:gap-x-8 lg:pt-24 xl:pt-32 lg:pb-52">
          ...
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              ...
              <h1 className="relative w-fit tracking-tight mt-16 font-bold !leading-tight text-gray-900 text-5xl md:text-6xl lg:text7xl">
              ...
              <p className="mt-8 text-lg lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap">
                ...
                MinCase allows you to project your memories, not jus t your phone case.
              </p>
              ...
              <ul className="mt-8 space-y-2 text-left font-medium flex flex-col items-center sm:items-start">
                <div className="space-y-2">
                  ...
                  <li className="flex gap-1.5 items-center text-left">
                    <Check className="h-5 w-5 shrink-0 text-green-600" />
                    5 years of experience in custom cases
                  </li>

                  <li className="flex gap-1.5 items-center text-left">
                    <Check className="h-5 w-5 shrink-0 text-green-600" />
                    Mordem and sleek design
                  </li>
                </div>
              </ul>
              ...
              <div className="mt-12 flex flex-col sm:flex-row items-center sm:items-start gap-5">
                ...
                <div className="flex flex-col justify-between items-center sm:items-start">
                  ...
                  <p><span className="font-semibold">1.384</span> happy customers</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16">
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>"The case feels durable and I event got a compliment on the design.
                  ...
                  into yellow-ish color after a couple week. Love it!"
                </p>
              </div>

              <div className="flex gap-4 mt-2">
                <img className="rounded-full w-12 h-12 object-cover" src="/users/user-1.png" alt="user image" />
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>"I usually keep my phone together with my keys in pocket and that led to
                  some pretty heavy scratchmarks on all of my last phone case. This one, besides
                  a barely noticeable scratch on the corner, {' '}
              ...
              <div className="flex gap-4 mt-2">
                <img className="rounded-full w-12 h-12 object-cover" src="/users/user-4.jpg" alt="user image" />
                <div className="flex flex-col">
        ...
        <MaxWidthWrapper className="py-24">
          <div className="mb-12 px-6 lg:px-8">
            <div className="mx-auto max-w-2xl sm:text-center">
              <h2 className="order-1 mt-2 tracking-tighter text-center text-balance
              !leading-tight font-bold text-5xl md:text-6xl text-grey-900">
          ...
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            <div className="relative flex flex-col items-center md:grid grid-cols-2 gap-40">
              <img src="/arrow.png" alt="icon" className="absolute top-[25rem] md:top-1/2 
              ...
              rounded-xl bg-gray-900/5 ring-inset ring-gray-900/10 lg:rounded-2xl">
                <img src="/horse.jpg" alt="img" className="rounded-md object-cover
